...
\titlegraphic{ \includegraphics[width=0.001\paperwidth]{../../randregret_submission/article/tikz_figures/scale_param_effect.pdf} } %optional title page image
...
%%% TITLE PAGE INFO:
\title[ Random regret minimization models using Stata]{randregret: A command for fitting random regret minimization models using Stata } %[]] will appear in footline
\subtitle{Overview and examples}
\author{\'Alvaro A. Guti\'errez Vargas\footnote{ \href{https://alvarogutyerrez.github.io/}{alvarogutyerrez.github.io}} \\ Michel Meulders \\ Martina Vandebroek }
\institute{}
\date{}
